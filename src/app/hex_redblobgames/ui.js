    ...
    diagram.addHexCoordinates = function(converter, withMouseover) {
        ...
        if (withMouseover) {
            diagram.tiles
                ...
                .on('touchstart', function(d) { setSelection(d.hex); }, {passive: true});
        }
    ...
    diagram.addCubeCoordinates = function(withMouseover) {
        ...
        if (withMouseover) {
            diagram.tiles
                ...
                .on('touchstart', function(d) { return setSelection(d.cube); }, {passive: true});
        }
...
function makeNeighbors(id_diagram, id_code, converter, parity_var) {
    ...
    diagram.tiles
        ...
        .on('touchstart', setSelection, {passive: true});
...
function makeDistances() {
    ...
    diagram.tiles
        ...
        .on('touchstart', function(d) { mouseover = d.cube; redraw(); }, {passive: true})
        .on('touchmove', function(d) { mouseover = d.cube; redraw(); }, {passive: true})
        .each(function(d) {
...
function makeRotation() {
    ...
    diagram.tiles
        ...
        .on('touchstart', function(d) { target = d.cube; redraw(); }, {passive: true})
        .on('touchmove', function(d) { target = d.cube; redraw(); }, {passive: true});
...
function makeSpiral(id, spiral) {
    ...
    diagram.tiles
        ...
        .on('touchstart', function(d) { N = Cube.$length(d.cube); redraw(); }, {passive: true})
        .on('touchmove', function(d) { N = Cube.$length(d.cube); redraw(); }, {passive: true});
...
function makeIntersection() {
    ...
    diagram.tiles
        ...
        .on('touchstart', function(d) { center = d.cube; redraw(); }, {passive: true})
        .on('touchmove', function(d) { center = d.cube; redraw(); }, {passive: true});
...
function makePathfinding() {
    ...
    diagram.tiles
        ...
        .on('touchstart', function(d) { goal = d.cube; redraw(); }, {passive: true})
        .on('touchmove', function(d) { goal = d.cube; redraw(); }, {passive: true});
...
function makeLineDrawer() {
    ...
    // TODO: note that touchmove doesn't do what I want here because
    // it sends the event back to where the drag started, and I
    // instead want to set the goal to where the drag currently is.
    // This is a problem with all the diagrams on the page; I need to
    // rethink how the events work.
    diagram.tiles
        .on('mouseover', function(d) { goal = d.cube; redraw(); })
        .on('touchstart', function(d) { goal = d.cube; redraw(); }, {passive: true})
        .on('touchmove', function(d) { goal = d.cube; redraw(); }, {passive: true});
